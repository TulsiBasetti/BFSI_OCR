...
# Load dataset
df = pd.read_csv(r'C:\BFSI_OCR\data\Synthetic_Data.csv')
...
model.save_pretrained(r'C:\BFSI_OCR\unsupervised\transaction_classifier')
tokenizer.save_pretrained(r'C:\BFSI_OCR\unsupervised\transaction_classifier')
